...
if __name__ == '__main__':
    detector = detection_strategy.YOLOStrategy(480, r'src/models/weights/yolov8l-pose.pt')
    ...
    vid = cv2.VideoCapture('/Users/egorken/Downloads/10 Min Squat Workout with 10 Variations - No Repeats No Talking.mp4')
    while True:
        _, frame = vid.read()
        try:
